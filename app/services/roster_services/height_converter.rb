module RosterServices
    class HeightConverter

        def initialize(height_string)
            @height_string = height_string
        end
...
#Called by RosterServices::HeightConverter.new(~~~~height veriable~~~~).convert_height
